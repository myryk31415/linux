 ...
 * Copyright (c) 2025 Paul Adam <adamp@posteo.de>
 */
...
static int ili9881c_tcl_on(struct ili9881c_tcl *ctx)
{
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_WRITE_CONTROL_DISPLAY,
				     0xc7);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_WRITE_POWER_SAVE, 0xa7);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x50, 0x74);
	mipi_dsi_dcs_set_display_brightness_multi(&dsi_ctx, 0x0074);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_SET_PARTIAL_COLUMNS,
				     0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x60, 0x14);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa0, 0x15);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, MIPI_DCS_READ_DDB_START, 0x38);
...
static int ili9881c_tcl_probe(struct mipi_dsi_device *dsi)
{
	...
	drm_panel_init(&ctx->panel, dev, &ili9881c_tcl_panel_funcs,
